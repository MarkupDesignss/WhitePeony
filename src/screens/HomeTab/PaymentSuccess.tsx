...
const PaymentSuccess = ({ navigation }: any) => {
  ...
  return (
    <SafeAreaView style={styles.page} ref={ref} collapsable={false}>
      ...
      <Text style={styles.sub}>
        Your items has been placed successfully. Your Order Id:#20356890
      </Text>
      <TouchableOpacity
      ...
      >
        {processing ? (
          ...
          <Text style={styles.downloadText}>Track Order</Text>
        )}
      </TouchableOpacity>
      ...
      <TouchableOpacity
        style={styles.back}
        onPress={() =>
          navigation.navigate('BottomTabScreen', { screen: 'HomeScreen' })
        }
      >
